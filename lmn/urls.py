...
urlpatterns = [
    ...
    path('notes/search/', views_notes.notes_search, name='notes_search'),
    ...
    path('accounts/logout/', auth_views.LogoutView.as_view(template_name='registration/goodbye.html'), name='logout'),
